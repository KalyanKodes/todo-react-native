...
const Login = () => {
    ...
    return (
        <View style={styles.screenWrapper}>
            ...
            <View>
                <Text style={themeStyles.primaryHeading}>Login</Text>
            </View>
            ...
            <View style={styles.form}>
                ...
                <TouchableOpacity style={[themeStyles.primaryButtonDisabled, {marginTop: 'auto'}]} disabled = {true}>
                    <Text style={themeStyles.primaryButtonDisabledText}>Login</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={{marginTop: '', gap: 30}}>
                <TouchableOpacity style={themeStyles.secondaryButton}>
                    ...
                    <Text style={themeStyles.label}>Continue with Google</Text>
                </TouchableOpacity>
                <TouchableOpacity style={themeStyles.secondaryButton}>
                    <FontAwesome name="apple" size={24} color={theme === "dark" ? "#FFFFFF" : "#000000"} />
                    <Text style={themeStyles.label}>Continue with Apple</Text>
                </TouchableOpacity>
            </View>

            <Text style={[themeStyles.label, { marginHorizontal: 'auto' }]}>Don't have an account? <Link href={"/auth/createAccount"} style={{color: "gray"}}>Register</Link></Text>
        </View>
    )
}
